<div class="grid-container">
	<h2 class="script">Staying here</h2>
	<section id="accommodations" class="callout">
		...
		<p>The official hotel will be at the <a href="http://www.marriott.com/meeting-event-hotels/group-corporate-travel/groupCorp.mi?resLinkData=Lewin-Levine%20Wedding%5Esbppr%60LLWLLWA%7CLLWLLWB%60229.00%60USD%60false%604%609/6/18%609/10/18%608/3/18&app=resvlink&stop_mobi=yes" target='_blank'>Courtyard Marriott Paso Robles.</a></p>

		<p>This will be the location from which the shuttles will depart before the ceremony and to which they'll arrive for the afterparty.</p>
		...
		<div class="grid-x">
			<div style="margin: 0 auto;"><a href="http://www.marriott.com/meeting-event-hotels/group-corporate-travel/groupCorp.mi?resLinkData=Lewin-Levine%20Wedding%5Esbppr%60LLWLLWA%7CLLWLLWB%60229.00%60USD%60false%604%609/6/18%609/10/18%608/3/18&app=resvlink&stop_mobi=yes" target='_blank'><button class='button'>Reserve your room</button></a></div>
		</div>
	</section>
</div>